...
from crew_custom_tools.tools.finance.yfinance_news import GetTickerNewsInput, YahooFinanceNewsTool
...
def test_run_successful_news_retrieval_with_limit(tool_instance, mocker):
    mock_yfinance_ticker = mocker.patch("crew_custom_tools.tools.finance.yfinance_news.yf.Ticker")
